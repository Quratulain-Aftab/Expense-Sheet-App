...
@interface HomeViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate,UISearchControllerDelegate,UITextFieldDelegate,UIImagePickerControllerDelegate,UIViewControllerPreviewingDelegate,UINavigationControllerDelegate,UIViewControllerPreviewingDelegate>
...
@property (weak, nonatomic) IBOutlet UILabel *noExpenseSheetMainViewLabel;
